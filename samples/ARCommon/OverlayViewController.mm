...
- (void) showOverlay
{
    ...
    mainOptionsAS = [[UIActionSheet alloc] initWithTitle:@"Happiness detected!"
                                                  delegate:self
    ...
    [mainOptionsAS addButtonWithTitle:@"See more info..."];
...
- (void) mainOptionClickedButtonAtIndex:(NSInteger)buttonIndex
{
    if (buttonIndex == selectTargetIx)
    {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:@"GoRings" object:nil];
    }
    else
    {
        return;

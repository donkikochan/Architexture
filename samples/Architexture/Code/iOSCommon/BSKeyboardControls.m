...
- (id)init
{
    if (self = [super init])
    {
        ...
        // Default colors
        self.barStyle = KEYBOARD_TOOLBAR_STYLE;
        self.previousNextTintColor = KEYBOARD_TOOLBAR_BUTTON_TINT;
        self.doneTintColor = KEYBOARD_TOOLBAR_DONE_TINT;
        
        // Default labels
        self.previousTitle = KEYBOARD_TOOLBAR_PREVIOUS;
        self.nextTitle = KEYBOARD_TOOLBAR_NEXT;
        ...
        self.segmentedPreviousNext.tintColor = KEYBOARD_TOOLBAR_BUTTON_TINT;
        ...
        // Create done button
        self.buttonDone = [[UIBarButtonItem alloc] initWithTitle:KEYBOARD_TOOLBAR_DONE
